  ...
  return (
    ...
    <div className="min-h-screen  relative bg-black text-gray-200 flex flex-col justify-center items-center p-8">
      <div className="w-full max-w-6xl text-start mb-12">
        <h2 className="md:text-5xl text-3xl mt-10 mb-4">Contact Us</h2>
      ...
      <form
        ...
        className="w-full max-w-4xl bg-transparent md:p-8 p-1 space-y-6 "
      >
        ...
        <p className="md:text-lg text-sm mt-6 text-balance lg:text-balance py-4 space-y-2">By Clicking {`"Submit"`}, I agree to receive promotional and marketing material.

...
export default function EmployeePerks() {
    ...
    return (
      <div className="bg-black py-8">
        {/* Heading */}
        <h1 className="text-3xl mt-6 px-2 sm:text-4xl lg:text-5xl text-white text-center md:mb-10">
          Employee Perks (India)
        </h1>
  
        {/* Perks Grid */}
        <div className="container px-2 md:px-14 mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 py-12">
          {perks.map((perk) => (
            <div
              key={perk.id}
              className="bg-neutral-900 text-neutral-400 md:p-10 p-4 flex flex-col items-center text-center"
            >
              <Image
              height={100}
              width={100}
          ...
          {/* Join Us Box */}
      <div className="bg-teal-600 text-white p-4 flex  flex-col items-center justify-center hover:shadow-lg transition w-screen md:w-auto">
        <h2 className="text-lg sm:text-xl lg:text-2xl mb-2">Join Us</h2>
        <div className="border-2 border-white flex justify-center items-center rounded-full h-14 w-14">

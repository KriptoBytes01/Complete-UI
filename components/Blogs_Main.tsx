...
export default function Blogs_Main() {
  ...
  return (
    <>
      <div className="bg-slate-950 py-12 md:px-20 px-2 brightness-100">
          ...
          {blogData.map((blog, index) => (
            ...
            >
              ...
              <div className="px-4 py-6 flex flex-col justify-between items-start h-full">
                <div className="md:text-lg text-sm sm:text-lg bg-zinc-800 w-fit px-4 py-1 text-gray-100 mb-6">
                  {blog.category}
                </div>
                
                <h2 className="text-white text-xl font-semibold mb-4">{blog.title}</h2>
                
                <p className="text-white md:text-base text-sm mb-4">{blog.description}</p>

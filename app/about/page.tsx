...
export default function About() {
  return (
    ...
    <div className="bg-black">
        ...
        <div className="container relative mx-auto flex flex-col items-start justify-center min-h-screen px-6 lg:px-28 py-8 md:py-16 text-white">
          <h1 className="text-2xl font-serif md:text-5xl mb-8 leading-tight text-balance animate-slide-in">
            {`We’re`} Building For Billions And Crafting Stories Of Bold Transformation
          </h1>
          <p className="text-sm md:text-lg max-w-2xl text-start text-balance mb-8 animate-slide-in">
            Welcome to our company! We are dedicated to delivering exceptional service
            and innovative solutions tailored to your needs.
          </p>
          <button className="flex items-center justify-start w-fit px-4 py-2 md:px-8 md:py-3 bg-teal-600 text-white hover:bg-teal-500 transition animate-slide-in">
            {`Let's`} Talk
      ...
      <div className="bg-black  text-white px-5 py-3 md:py-14 md:px-28 ">
        <div className="container mx-auto md:gap-10 md:mb-16 flex flex-col md:flex-row items-start px-2 lg:px-28">
          <h1 className="md:text-5xl text-2xl md:w-1/2 mb-6 md:mb-0">
            We are not different. We lead by creating a difference
          </h1>
          <p className="md:text-lg text-sm md:w-1/2 text-gray-400">
  ...
  <div className="md:py-20 py-4 px-6 md:px-28 text-white bg-zinc-900">
  <div className="items-center justify-center h-full mt-4 border-r-4 border-teal-600"></div>
        ...
        <div className="container mt-20 mx-auto text-center">
          ...
          <div className="grid grid-cols-1 bg-transparent md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="flex flex-col items-center bg-zinc-800 p-8 md:p-20 shadow-lg">
              <h3 className="md:text-5xl text-4xl text-teal-500  mb-4">4000+</h3>
              <h4 className="md:text-xl text-lg text-gray-100">Talent Pool</h4>
            </div>
            <div className="flex flex-col items-center bg-zinc-800 p-8 md:p-20 shadow-lg">
              <h3 className="md:text-5xl text-4xl text-teal-500  mb-4">2000+</h3>
              <h4 className="md:text-xl text-lg text-gray-100">Products Engineered</h4>
            </div>
            <div className="flex flex-col items-center bg-zinc-800 p-8 md:p-20 shadow-lg">
              <h3 className="md:text-5xl text-4xl text-teal-500 mb-4">1500+</h3>
              <h4 className="md:text-xl text-lg text-gray-100">Happy Clients</h4>
            </div>
            <div className="flex flex-col items-center bg-zinc-800 p-8 md:p-20 shadow-lg">
              <h3 className="md:text-5xl text-4xl text-teal-500 mb-4">22+</h3>
              <h4 className="md:text-xl text-lg text-gray-100">Industries Served</h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="md:py-16 py-10 bg-black">
    
      <div className="text-center mt-10 mb-12">
        <h1 className="text-white text-3xl md:text-5xl">Leadership</h1>
      </div>

      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:px-20 px-8 mb-20">
        {/* Box 1 */}
        <div className="bg-zinc-900 border border-gray-500  flex flex-col items-center shadow-lg">
          ...
          <p className="text-gray-300 md:text-base text-sm p-2 text-center">
